            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  name="appName" minlength="2" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">图片：</label>
                        <div class="col-sm-8">
                            <img src="<%=path%>/static/img/add.png" id="imgs" style="width: 300px" />
                            <input type="hidden" id="urlImg" name="url" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">广告地址：</label>
                        <div class="col-sm-8">
                            <input  name="advertUrl" minlength="2" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                </div>
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">图片：</label>
                        <div class="col-sm-8">
                            <img src="<%=path%>/static/img/add.png" id="img_s" style="width: 300px"  />
                            <input type="text" id="url_Img" name="url" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">广告地址：</label>
...
<script src="<%=path%>/static/js/pageJs/advert.js"></script>
</body>
<%--<script>--%>
<%--$(function () {--%>
<%--alert("asdflsfa");--%>
    ...
    layui.use('upload', function() {
        ...
        var uploadInst = upload.render({
            ...
            , before: function (obj) {
                //预读本地文件示例，不支持ie8
                obj.preview(function (index, file, result) {
                    $('#img_s').attr('src', result); //图片链接（base64）
                });
            }
            , done: function (res) {
                //如果上传失败
