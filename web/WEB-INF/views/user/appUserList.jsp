            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    <div class="panel-body form-group" style="margin-bottom:0px;">
                        ...
                        <label class="col-sm-1 control-label" style="padding-top: 7px">手机号</label>
                        <div class="col-sm-2">
                        ...
                        <label class="col-sm-1 control-label" style="padding-top: 7px">性别</label>
                        <div class="col-sm-2">
                    ...
                    <div class="panel-body form-group" style="margin-bottom:0px;">
                        <label class="col-sm-1 control-label" style="padding-top: 7px">粉丝数</label>
                        <div class="col-sm-2">
                        ...
                        <label class="col-sm-1 control-label" style="padding-top: 7px">签名</label>
                        <div class="col-sm-2">
                            <input type="text" name="remark" placeholder="签名" id="remark" class="form-control" />
                        </div>
                        <label class="col-sm-1 control-label" style="padding-top: 7px">状态</label>
                        <div class="col-sm-2">
                            <select id="appUserStatus" name="status"  class="form-control">
                                <option value="">全部</option>
...
<div class="modal fade" id="fs_modal" tabindex="-1" role="dialog" aria-labelledby="fs_modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
...
<script src="<%=path%>/static/js/pageJs/appUser.js"></script>
