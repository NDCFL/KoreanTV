        ...
        <div class="ibox-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    ...
                    <div class="col-sm-2">
                        <select id="userId" name="userId"  onchange="getList(this.value);" class="form-control">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">关注状态：</label>
                        <div class="col-sm-8">
...
<script src="<%=path%>/static/js/pageJs/userFriend.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
