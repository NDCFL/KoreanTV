            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">剧下载记录名称：</label>
                        <div class="col-sm-8">
                            <input  name="title" minlength="2" placeholder="剧下载记录名称" id="title" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">剧下载记录级别：</label>
                        <div class="col-sm-8">
                            <input  name="level" minlength="2" placeholder="剧下载记录级别（0-10）" id="level" maxlength="20" type="number" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">剧下载记录说明：</label>
                        <div class="col-sm-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">剧下载记录状态：</label>
                        <div class="col-sm-8">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">剧下载记录名称：</label>
                            <div class="col-sm-8">
                                <input  name="title" minlength="2" id="title_" maxlength="20" type="text" value="" class="form-control" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">剧下载记录级别：</label>
                            <div class="col-sm-8">
                                <input  name="level" minlength="2" id="level_" maxlength="20" type="number" class="form-control" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">剧下载记录说明：</label>
...
<script src="<%=path%>/static/js/pageJs/downHistory.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
