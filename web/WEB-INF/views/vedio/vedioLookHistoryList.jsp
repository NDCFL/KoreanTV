            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    <div class="panel-body form-group" style="margin-bottom:0px;">
                        ...
                        <div class="col-sm-2">
                            <select id="vedioId" name="vedioId" onchange="getSection(this.value);"  class="form-control">
                                <option value="">全部</option>
                            </select>
                        </div>
                        <label class="col-sm-1 control-label" style="padding-top: 7px">集名称</label>
                        <div class="col-sm-2">
                            <select id="vedioSectionId_" name="vedioSectionId" class="form-control">
                                <option value="">全部</option>
                            </select>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">剧观看历史状态：</label>
                        <div class="col-sm-8">
...
<script src="<%=path%>/static/js/pageJs/vedioLookHistory.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
...
<script>
    ...
    function  getSection(id) {
        $("#vedioSectionId_").html('<option value="">全部</option>');
        $.post(
            "/vedioSection/getSectionList/"+id,
            function (data) {
                $("#vedioSectionId_").select2({
                    data: data
                });
                $("#select2-vedioSectionId_-container").remove();
            },
            "json"
        );
    }
